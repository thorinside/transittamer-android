...
import org.nsdev.apps.transittamer.authenticator.BootstrapAuthenticatorActivity;
...
public class BootstrapAuthenticatorTest extends ActivityInstrumentationTestCase2<BootstrapAuthenticatorActivity> {
    ...
    /**
     * Create test for {@link org.nsdev.apps.transittamer.authenticator.BootstrapAuthenticatorActivity}
     */
